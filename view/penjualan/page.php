            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6 class="text-lg">List Penjualan</h6>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 mx-4">
                                <thead>
                                    <tr>
                                    <th class="text-secondary font-weight-bolder opacity-7">Tanggal Penjualan</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Penjualan</h5>
                ...
                <div class="modal-body">
                    <form id="formdata" action="../controller/crud_controller.php" method="post">
                        <input type="hidden" class="form-control" id="type-master" name="type_master" value="penjualan">
